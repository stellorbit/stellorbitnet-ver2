...
export const astroPosts: AstroPostMeta[] = [
  ...
  },
  {
    ...
    categories: ['音楽'],
    headings: [
      { depth: 2, slug: "protools-install", text: "ProToolsの下準備～インストール" },
      { depth: 3, slug: "letsbuy-audioif", text: "「ASIOドライバ」の準備を推奨。できればオーディオIFを買おう。" },
      { depth: 3, slug: "suggest-from-ai", text: "AIに聞いた厳選3機種" },
      { depth: 3, slug: "ilok-and-avid", text: "iLok・Avidアカウント登録・ダウンロード" },
      { depth: 2, slug: "initset-reco", text: "初回起動～おすすめ設定" },
      { depth: 3, slug: "soundset-caution", text: "注意" },
      { depth: 3, slug: "initstart-andmake", text: "初回起動設定とセッション作成" },
      { depth: 3, slug: "mastermake", text: "マスターがない！！作ろう！そしてテンプレにしよう！" },
  ...
  },
  {
    ...
    headings: [
      ...
      { depth: 3, slug: "groupchat", text: "グループチャット機能" },
      { depth: 3, slug: "com-deprecation", text: "「コミュニティ」機能の非推奨・廃止" },
      { depth: 2, slug: "impact", text: "影響と今後の展望" },
      { depth: 3, slug: "mycommunity", text: "実は影響をモロに受けています・・・" }
    ],
  },
  {
    slug: 'fl-studio-rto',
    ...
    categories: ['DTM'],
    headings: [
      { depth: 2, slug: "fl-weakness", text: "FL Studioの「唯一」の弱点" },
      { depth: 3, slug: "fl-grade", text: "FL Studioの各種グレード" },
      { depth: 2, slug: "initial-cost", text: "DAWだけではない。音楽制作を始める費用" },
      { depth: 3, slug: "other-equip", text: "他の機材の購入費用概算" },
      { depth: 2, slug: "split-payment", text: "分割払いという方法もあるが・・・" },
      { depth: 3, slug: "exam", text: "「審査」の壁" },
      { depth: 3, slug: "interest-rates", text: "金利・手数料" },
      { depth: 2, slug: "rent-to-own", text: "Rent-to-Own(レンタル購入)の導入を推す理由" },
